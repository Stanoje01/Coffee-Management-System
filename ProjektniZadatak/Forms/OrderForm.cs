...
namespace ProjektniZadatak
{
    public partial class OrderForm : UserControl
    {
        ...
        public OrderForm()
        {
            ...
            displayTotalPrice();
            cashierOrderForm_receiptBtn.Enabled = false;
        }
        ...
        private void cashierOrderForm_addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Prvo morate da izaberete proizvod!!!", "Greska", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        string insertOrder = "INSERT INTO orders (customer_id, prod_id, prod_name, prod_type, qty,  prod_price, order_date)" 
                            + "VALUES(@customerID, @prodID, @prod_name, @prod_type, @qty,  @prodPrice, @orderDate)";
                        ...
                        using(SqlCommand cmd = new SqlCommand(insertOrder, connect)) {
                            ...
                            cmd.Parameters.AddWithValue("@prod_name", cashierOrderForm_prodName.Text.Trim());
                            cmd.Parameters.AddWithValue("@prod_type", cashierOrderForm_type.Text.Trim());
        ...
        public void IDGenerator() {
            using (SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Sasa\Documents\baza.mdf;Integrated Security=True;Connect Timeout=30"))
            {
                connect.Open();
        ...
        private void cashierOrderForm_payBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nešto nije u redu.", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                if (MessageBox.Show("Da li želite da naplatite?", "Confirmation Message"
                    ...
                    if (connect.State == ConnectionState.Closed)
                    {
                        try
                        {
                            ...
                            using (SqlCommand cmd = new SqlCommand(insertData, connect))
                            {
                                ...
                                MessageBox.Show("Uspešna transakcija!", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            displayTotalPrice();
            cashierOrderForm_receiptBtn.Enabled = true;
        }
        ...
        private void cashierOrderForm_receiptBtn_Click(object sender, EventArgs e)
        {
            ...
            List<CashierOrdersData> ordersList = (List<CashierOrdersData>)cashierOrderForm_orderTable.DataSource;
            ordersList.Clear();


            cashierOrderForm_orderTable.DataSource = null;
            cashierOrderForm_orderTable.DataSource = ordersList;
            cashierOrderForm_amount.Text = "";
            cashierOrderForm_change.Text = "";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            y += tableMargin;
            string[] header = { "ID","CID", "ProdID", "Naziv", "Tip", "Kolicina", "Cena" };
            ...
            e.Graphics.DrawString("Ukupna cena: \t RSD" + totalPrice + "\nDato novca: \t RSD"
                + cashierOrderForm_amount.Text + "\n\t\t------------\nKusur: \t RSD" + cashierOrderForm_change.Text, labelFont, Brushes.Black, labelX, y);
